...
*/
        ...
        base58Prefixes[PUBKEY_ADDRESS] = boost::assign::list_of(23).convert_to_container<std::vector<unsigned char> >();; // A
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = boost::assign::list_of(83).convert_to_container<std::vector<unsigned char> >();;
